...
const Testimonials = () => {
  ...
  return (
    <section className="mt-20">
      <div className="">
        <Carousel
          className=" place-items-center py-5 z-10"
          swipeable={true}
          draggable={false}
          showDots={true}
        ...
        >
          {testimonials.map((item, idx) => (
            <div key={idx} className="flex flex-col px-10 md:px-14 xl:px-20 py-5 ">
              <div className="bg-white rounded-xl border shadow-md">
                ...
                <figure>
                  <blockquote>
                    <p className="text-gray-800 px-4 py-1">{item.quote}</p>
                  </blockquote>
